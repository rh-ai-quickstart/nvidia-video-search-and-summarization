...
Google::Protobuf::DescriptorPool.generated_pool.build do
  add_file("schema.proto", :syntax => :proto3) do
    ...
    add_message "nv.LLM" do
      ...
      repeated :conversations, :message, 2, "nv.Conversation"
      repeated :embeddings, :message, 3, "nv.Embedding"
    end
    add_message "nv.Conversation" do
      optional :id, :string, 1
...
module Nv
  ...
  Conversation = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("nv.Conversation").msgclass
