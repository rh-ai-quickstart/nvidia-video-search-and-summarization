...
import { SensorProxyConfig } from '../../../interfaces/interfaces';

const SensorProxySettings: React.FC = () => {
    const [configData, setConfigData] = useState<SensorProxyConfig | null>(null);
        ...
        <Box sx={{ flexGrow: 1, padding: 2 }}>
            <Grid container spacing={3}>
                <Grid size={{ xs: 12 }}>
                    <Card elevation={2}>
                        <CardHeader
                            title='Sensor Proxy Configuration'
...
export default SensorProxySettings;
