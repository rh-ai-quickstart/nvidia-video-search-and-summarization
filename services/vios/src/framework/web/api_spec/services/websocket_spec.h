...
const std::vector<ApiSpec> WEBSOCKET_API_SPEC = {
    {"/addDummyUdpTrack"},
    {"/event/streambridge/ext/peerconnection/status",
     {{"peerId", JsonType::String, true},
      {"status", JsonType::String, true}}},
    
    {"/api/v1/streambridge/ping"},
    {"/api/v1/live/ping"},
    {"/api/v1/replay/ping"},
};
