...
public:
  ...
  void setRtcpBaseTime(const struct timeval& rtcptime) { fRtcpBaseTime = rtcptime; }
  const struct timeval& getRtcpBaseTime() { return fRtcpBaseTime; }
