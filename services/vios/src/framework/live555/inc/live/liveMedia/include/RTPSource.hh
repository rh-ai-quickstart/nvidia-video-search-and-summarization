...
public:
  ...
  // Add frameId & timestamp using SEI nal units
  void enableFrameIdSupport() { fFrameIdSupport = True; }
  void useCameraNtpTime() { fUseCameraNtpTime = True; }
  void setCodecName(std::string codec) { fCodecName = codec; }
  void setUrl(std::string url) { fUrl = url; }
  std::string getUrl() { return fUrl; }
